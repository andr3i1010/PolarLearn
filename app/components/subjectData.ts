// Dit is een verzameling van de vakken die beschikbaar zijn in PolarLearn
...
export const isValidVak = (subjectCode: string): boolean => {
    return Vakken.some(v => v.afkorting === subjectCode);
}