...
/**
  ...
  /**
   * `prisma.forumPostReply`: Exposes CRUD operations for the **ForumPostReply** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more ForumPostReplies
    * const forumPostReplies = await prisma.forumPostReply.findMany()
    * ```
    */
  get forumPostReply(): Prisma.ForumPostReplyDelegate<ExtArgs, { omit: OmitOpts }>;
   ...
   * `prisma.forumVote`: Exposes CRUD operations for the **ForumVote** model.
    ...
    * ```
    */
  get forumVote(): Prisma.ForumVoteDelegate<ExtArgs, { omit: OmitOpts }>;
