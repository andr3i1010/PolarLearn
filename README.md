...
Als je wilt bijdragen aan PolarLearn en kan programmeren in TypeScript met Next.js, kan je het best polarlearn@polarnl.org mailen om te vragen hoe je kan helpen. lees ook de [CONTRIBUTING.md](https://github.com/polarnl/PolarLearn/blob/stable/CONTRIBUTING.md) voor de duidelijkheid.
