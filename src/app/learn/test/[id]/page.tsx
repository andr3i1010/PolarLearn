...
import { getWordPairs, saveTestResults } from "@/app/actions";

export default function TestMode({ listId }: { listId: string }) {
  ...
  const handleSubmit = async () => {
    ...
    if (index + 1 < wordPairs.length) {
      ...
      setFinished(true);
      await saveTestResults(correctCount, incorrectCount, listId);
    }
  };
